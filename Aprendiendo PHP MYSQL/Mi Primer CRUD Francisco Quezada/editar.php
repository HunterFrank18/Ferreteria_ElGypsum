...
$querybuscar = mysqli_query($con, "SELECT * FROM usuarios WHERE cod=$codigo"); // Buscamos y obtenemos entre todas los registros al usuario que coincidacon el id a buscar.
...
{    
    ...
    $querymodificar = mysqli_query($con, "UPDATE usuarios SET nom='$nombre1',correo='$correo1',tel='$telefono1' WHERE cod=$codigo1"); // Creamos la consulta de Actualización a la base de //Datoss
