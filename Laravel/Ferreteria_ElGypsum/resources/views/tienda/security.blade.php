...
<head>
    ...
    <title>Seguridad | Ferreteria</title>
...
<header class="store-header">
    <div class="top-line">
        <div class="container">
            <span><i class="fa-solid fa-lock"></i> Categoria Seguridad</span>
            <span><i class="fa-solid fa-ruler-combined"></i> Escoge medida, marca y precio correcto</span>
        </div>
    </div>
    ...
    <nav class="catalog-nav">
        <div class="container">
            ...
            <div class="nav-links">
                <a href="{{ url('/') }}">Inicio</a>
                <a class="active" href="{{ url('/security') }}">Seguridad</a>
    ...
    <section class="hero-security">
        <div class="container">
            <div class="hero-content">
                <span class="section-kicker"><i class="fa-solid fa-shield-halved"></i> Seguridad</span>
                <h1>Candados, bisagras y herrajes con medidas reales.</h1>
    ...
    <section id="productos" class="catalog-section">
        <div class="container">
            <div class="section-heading">
                <div>
                    <span class="section-kicker"><i class="fa-solid fa-layer-group"></i> Catalogo de seguridad</span>
            ...
            <div class="product-grid">
                    ...
                    <article class="product-card" data-product-card>
                        <a class="product-image" href="{{ $whatsapp }}">
                            <img
                                src="{{ $image }}"
                                alt="{{ $producto->name }}"
                                onerror="this.onerror=null; this.src='{{ asset('Fondos/ferreteria4.jpg') }}';"
                            >
                            <span class="product-badge">Seguridad</span>
                        </a>

                        <div class="product-info">
                            <span class="product-category">{{ optional($producto->category)->name ?? 'Seguridad' }}</span>
                            <h3>{{ $producto->name }}</h3>
                ...
                @empty
                    <div class="empty-state">
                        ...
                        <h3>Aun no hay productos de seguridad</h3>
                        <p>Cuando agregues productos activos con stock en la categoria Seguridad, apareceran automaticamente aqui.</p>
                    </div>
                @endforelse
            </div>
        </div>
