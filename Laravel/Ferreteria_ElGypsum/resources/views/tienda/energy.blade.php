...
<head>
    ...
    <title>Electricidad | Ferreteria</title>
...
<header class="store-header">
    <div class="top-line">
        <div class="container">
            <span><i class="fa-solid fa-bolt"></i> Categoria Electricidad</span>
    ...
    <nav class="catalog-nav">
        <div class="container">
            ...
            <div class="nav-links">
                <a href="{{ url('/') }}">Inicio</a>
                <a class="active" href="{{ url('/energy') }}">Electricidad</a>
...
<main id="lista-productos">
    <section class="hero-electric">
        <div class="container">
            <div class="hero-content">
                <span class="section-kicker"><i class="fa-solid fa-plug-circle-bolt"></i> Electricidad</span>
                <h1>Material electrico con marcas y precios por variante.</h1>
                <p>Escoge la marca disponible. El precio, stock y boton de carrito se actualizan automaticamente.</p>
    ...
    <section id="productos" class="catalog-section">
        <div class="container">
            <div class="section-heading">
                <div>
                    <span class="section-kicker"><i class="fa-solid fa-layer-group"></i> Catalogo electrico</span>
                    <h2>Productos de electricidad</h2>
                    <p>Un card por producto, con marcas y precios desde la base de datos.</p>
                </div>
            ...
            <div class="product-grid">
                @forelse ($productos as $producto)
                    ...
                    <article class="product-card" data-product-card>
                        <a class="product-image" href="{{ $whatsapp }}">
                            ...
                            <span class="product-badge">Electricidad</span>
                        </a>

                        <div class="product-info">
                            <span class="product-category">{{ optional($producto->category)->name ?? 'Electricidad' }}</span>
                            <h3>{{ $producto->name }}</h3>
                ...
                @empty
                    <div class="empty-state">
                        ...
                        <h3>Aun no hay productos de electricidad</h3>
                        <p>Cuando agregues productos activos con stock en Electricidad, apareceran automaticamente aqui.</p>
                    </div>
                @endforelse
            </div>
        </div>
...
<script>
    ...
    function updateElectricCard(card) {
    ...
    document.querySelectorAll('[data-product-card]').forEach(card => {
        updateElectricCard(card);

        const select = card.querySelector('.variant-select');
        select.addEventListener('change', () => updateElectricCard(card));
    });
</script>
