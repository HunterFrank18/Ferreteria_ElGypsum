...
<head>
    ...
    <title>Tornilleria | Ferreteria</title>

    <link rel="stylesheet" href="{{ asset('css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/sweetalert2.min.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/tornilleria.css') }}">
</head>
<body>
@php
...
<header class="store-header">
    <div class="top-line">
        <div class="container">
            <span><i class="fa-solid fa-screwdriver"></i> Categoria Tornilleria</span>
            <span><i class="fa-solid fa-ruler-combined"></i> Escoge tipo, medida y precio correcto</span>
        </div>
    </div>
    ...
    <nav class="catalog-nav">
        <div class="container">
            <a class="brand" href="{{ url('/') }}">
                <span><i class="fa-solid fa-screwdriver"></i></span>
                Ferreteria El Gypsum
            </a>

            <div class="nav-links">
                <a href="{{ url('/') }}">Inicio</a>
                <a class="active" href="{{ url('/tornilleria') }}">Tornilleria</a>
...
<main id="lista-productos">
    <section class="hero-fasteners">
        <div class="container">
            <div class="hero-content">
                <span class="section-kicker"><i class="fa-solid fa-screwdriver"></i> Tornilleria</span>
                <h1>Tornillos, tuercas y fijaciones por medida.</h1>
                <p>Selecciona marca, medida o presentacion. El precio, stock y carrito se actualizan automaticamente.</p>
    ...
    <section id="productos" class="catalog-section">
        <div class="container">
            <div class="section-heading">
                <div>
                    <span class="section-kicker"><i class="fa-solid fa-layer-group"></i> Catalogo de tornilleria</span>
                    <h2>Productos de tornilleria</h2>
            ...
            <div class="product-grid">
                @forelse ($productos as $producto)
                    ...
                    <article class="product-card" data-product-card>
                        <a class="product-image" href="{{ $whatsapp }}">
                            ...
                            >
                            <span class="product-badge">Tornilleria</span>
                        </a>

                        <div class="product-info">
                            <span class="product-category">{{ optional($producto->category)->name ?? 'Tornilleria' }}</span>
                            <h3>{{ $producto->name }}</h3>
                ...
                @empty
                    <div class="empty-state">
                        ...
                        <h3>Aun no hay productos de tornilleria</h3>
                        <p>Cuando agregues productos activos con stock en la categoria Tornilleria, apareceran automaticamente aqui.</p>
                    </div>
                @endforelse
            </div>
        </div>
